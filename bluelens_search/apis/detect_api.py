...
class DetectApi(object):
    ...
    def detect_objects(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.detect_objects(callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.detect_objects_with_http_info(**kwargs)
        else:
            (data) = self.detect_objects_with_http_info(**kwargs)
            return data

    def detect_objects_with_http_info(self, **kwargs):
        """
        Query to detect obejects in the image you sent
        Image file that needs to be detected objects
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.detect_objects_with_http_info(callback=callback_function)
        ...
        return self.api_client.call_api('/', 'POST',
                                        ...
                                        response_type='DetectObjectsResponse',
